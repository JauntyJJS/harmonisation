# Get Number Of Vessels With High Stenosis Severity (Excluding LM)
...
``` r
get_number_of_vessels_with_high_stenosis_severity_exclude_LM(
  vessel_data,
  vessel_name_column,
...
An integer from 0 to 3 indicating the number of vessels with stenosis
severity of 50
